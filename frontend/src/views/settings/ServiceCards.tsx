...
import {type ServiceDef} from '../../services/services'
...
/**
 * The grid of connectable service cards shared by the Services and AI
 * settings tabs; clicking a card opens its connect dialog.
 */
export function ServiceCardGrid({services}: {services: ServiceDef[]}) {
